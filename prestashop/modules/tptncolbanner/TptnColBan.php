...
class TptnColBan extends ObjectModel
{
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'tptncolbanner` (`id_shop`, `id_homeslider_slides`)
	...
	public function reOrderPositions()
	{
		...
		$rows = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			LEFT JOIN `'._DB_PREFIX_.'tptncolbanner` hs ON (hss.`id_homeslider_slides` = hs.`id_homeslider_slides`)
