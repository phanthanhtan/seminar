...
class TptnColBanner extends Module
{
	...
	public function __construct()
	{
		...
		$this->description = $this->l('Adds a block to display banners in left-column.');
	}
	...
	public function hookActionShopDataDuplication($params)
	{
		Db::getInstance()->execute('
			INSERT IGNORE INTO '._DB_PREFIX_.'tptncolbanner (id_homeslider_slides, id_shop)
			SELECT id_homeslider_slides, '.(int)$params['new_id_shop'].'
			FROM '._DB_PREFIX_.'tptncolbanner
	...
	public function getSlides($active = null)
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			LEFT JOIN '._DB_PREFIX_.'tptncolbanner_slides hss ON (hs.id_homeslider_slides = hss.id_homeslider_slides)
			LEFT JOIN '._DB_PREFIX_.'tptncolbanner_slides_lang hssl ON (hss.id_homeslider_slides = hssl.id_homeslider_slides)
			...
			'form' => array(
				...
				'input' => array(
					array(
						...
						'name' => 'image',
						'lang' => true,
						'desc' => $this->l('Recommended width: 250px')
					),
					array(
						'type' => 'text',
						'label' => $this->l('Title'),
