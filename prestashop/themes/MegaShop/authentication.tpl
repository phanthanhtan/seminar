...
{if !isset($email_create)}
	...
	{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std">
...
<input type="hidden"  value="{rand(100000,999999)}" class="is_required validate form-control" data-validate="isPasswd" name="passwd" id="passwd" />
		...
		<div class="account_creation">
			...
			<div class="required password form-group">
				<label for="passwd">{l s='Password'} send by email <sup>*</sup></label>
		...
		{if $b2b_enable}
			<div class="account_creation">
				<h3 class="subheading">{l s='Your company information'}</h3>
				<p class="form-group">
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				<h3 class="subheading">{l s='Your address'}</h3>
				{foreach from=$dlv_all_fields item=field_name}
