<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" class="std" id="login_form">
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p class="submit">
                    ...
                    <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button button-medium"><i class="fa fa-lock left"></i>{l s='Login'}</button>
				</p>
			</div>
		</fieldset>
	</form>
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			...
			{/if}
			<h3 class="top-indent subheading">{l s='Delivery address'}</h3>
			{$stateExist = false}
			{$postCodeExist = false}
			{$dniExist = false}
			...
			<div id="opc_invoice_address" class="is_customer_param">
				...
				<h3 class="top-indent subheading">{l s='Invoice address'}</h3>
