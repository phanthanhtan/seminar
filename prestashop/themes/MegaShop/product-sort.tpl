...
<ul class="display">
    ...
    <li id="grid"><a class="tooltip" rel="nofollow" href="#" title="{l s='Grid'}"><i class="fa fa-th-large"></i></a></li>
    <li id="list"><a class="tooltip" rel="nofollow" href="#" title="{l s='List'}"><i class="fa fa-th-list"></i></a></li>
</ul>
